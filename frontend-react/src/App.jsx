...
function App() {
  ...
  // Group + sort incidents under each severity
  const groupIncidentsBySeverity = (list) => {
    const groups = {
      critical: [],
      high: [],
      medium: [],
  ...
  const groupedIncidents = groupIncidentsBySeverity(activeIncidents);
  const severityOrder = ["critical", "high", "medium", "low"];
  const hasAnyIncidents = severityOrder.some(
    (sev) => groupedIncidents[sev].length > 0
  );
  ...
  return (
    ...
    >
      {/* Center the main content but keep it wide */}
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        ...
        {lastAction && (
          ...
          >
            ...
            >
              Category: <strong>{lastAction.category}</strong> | Severity:{" "}
              <strong>{lastAction.severity?.toUpperCase()}</strong>
            </p>
            <p
              style={{
                color: "#60a5fa",
        ...
        >
          ...
          <div style={{ display: "flex", gap: "12px", marginBottom: "12px" }}>
            ...
            <button
              ...
              style={{
                background:
                  isLoading || !message.trim() ? "#475569" : "#2563eb",
                color: "white",
                padding: "12px 32px",
                borderRadius: "8px",
                border: "none",
          ...
          {["all", "critical", "high", "medium", "low"].map((severity) => (
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                background:
                  filter === severity ? "#2563eb" : "rgba(30, 41, 59, 0.7)",
                color: "white"
              }}
            >
          ...
          {!hasAnyIncidents ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              {severityOrder.map((sev) => {
                const list = groupedIncidents[sev];
                ...
                return (
                  <div key={sev}>
                    ...
                    >
                      {getSeverityIcon(sev)} {label} Incidents ({list.length})
                    </h3>
                    <div
                      style={{
                        display: "flex",
